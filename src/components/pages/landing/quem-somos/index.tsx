        ...
        >
          ...
          >
            ...
            <p className="text-center text-sm md:text-base opacity-70 wrap-break-word max-w-2xl mb-6">
              <Trans>
                A AmiCat's nasceu do desejo genuíno de mudar o destino de
                centenas de felinos nas ruas de Campo Grande. Somos voluntários
                apaixonados que dedicam tempo e recursos para resgatar, tratar e
                encontrar lares amorosos. Acreditamos que cada vida importa e
                que o amor pode curar as feridas mais profundas.
              </Trans>
            </p>
          </Flex>
