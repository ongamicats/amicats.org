...
import { HandFist, Info, Megaphone, Stethoscope, UserPlus } from 'lucide-react';
      ...
      <div className="grid gap-4 md:grid-cols-[auto_1fr] items-start">
        ...
        <div>
          <h3 className="text-xl font-semibold mt-1">
            <Trans>Doe Seu Tempo</Trans>
          </h3>
          <p className="text-base-content/80">
            <Trans>Existem várias formas de contribuir como voluntário</Trans>
          </p>
          ...
          <div className="mt-8 mb-8 grid gap-3">
            <div className="flex items-center gap-3 p-3 rounded-md bg-base-200">
              ...
              <div>
                <div className="font-semibold">
                  <Trans>Limpeza e Organização</Trans>
                </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-md bg-base-200">
              ...
              <div>
                <div className="font-semibold">
                  <Trans>Profissionais da Saúde</Trans>
                </div>
            ...
            <div className="flex items-center gap-3 p-3 rounded-md bg-base-200">
              ...
              <div>
                <div className="font-semibold">
                  <Trans>Apoio e Comunicação</Trans>
                </div>
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:gap-3 gap-2 justify-between">
            <div className="flex items-center gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                aria-label={t`Entrar em contato via WhatsApp`}
              >
                <svg
