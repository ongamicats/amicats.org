  ...
  return (
    <section className={cn('rounded-lg bg-base-100 p-6 shadow-sm')}>
      <div className="grid gap-4 md:grid-cols-[auto_1fr] items-start">
        ...
        <div>
          <h3 className="text-xl font-semibold mb-1"><Trans>Doação de Itens</Trans></h3>
          <p className="text-base-content/80"><Trans>Velhinhos ou novos, qualquer contribuição é bem-vinda</Trans></p>
          ...
          <div className="text-base-content/80 mt-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:items-start">
              <div className="md:pr-4 md:border-r md:border-base-300">
                <h4 className="font-semibold"><Trans>Itens para os Gatos</Trans></h4>
                <ul className="list-disc list-inside mt-1 space-y-1 text-sm">
                  <li><Trans>Ração para gatos</Trans></li>
                  <li><Trans>Areia higiênica</Trans></li>
                  <li><Trans>Cobertores e mantas</Trans></li>
                  <li><Trans>Arranhadores</Trans></li>
                  <li><Trans>Casinhas e tocas</Trans></li>
                  <li><Trans>Remédios e suplementos</Trans></li>
                  <li><Trans>Produtos de limpeza (desinfetantes, pás, vassouras, rodos)</Trans></li>
                  <li><Trans>Jornais</Trans></li>
                </ul>
              </div>

              <div>
                <h4 className="font-semibold"><Trans>Itens para Bazar</Trans></h4>
                <p className="text-sm mb-1">{t`Doe itens em bom estado para nosso bazar beneficente:`}</p>
                <ul className="list-disc list-inside mt-1 space-y-1 text-sm">
                  <li><Trans>Roupas em bom estado</Trans></li>
                  <li><Trans>Móveis</Trans></li>
                  <li><Trans>Decoração</Trans></li>
                  <li><Trans>Livros</Trans></li>
                  <li><Trans>Eletrônicos funcionando</Trans></li>
                  <li><Trans>Outros itens em boas condições</Trans></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:gap-3 gap-2">
            <a className="btn btn-primary flex items-center gap-2" href={wa} target="_blank" rel="noreferrer" aria-label={t`Doar itens via WhatsApp`}>
