...
export function OAbrigoSection() {
    return (
        <SectionContainer containerId='c-o-abrigo' sectionId="o-abrigo" background='bg-base-200'>
            <Container fluid id='innerc-o-abrigo' spacing='lg' className={'h-screen overflow-hidden'}>
                <Flex direction='row' align='stretch' gap={6} className='h-full py-10'>
                    <Flex id='c-abrigo-intro' justify='center' direction='col' grow className="items-center text-center">
                        ...
                        <h2 className="text-4xl xl:text-5xl font-bold mb-4 text-primary">O Abrigo</h2>
                        ...
                        <p className="pt-3 text-base opacity-70">
                    ...
                    <Flex grow direction='col' justify='center'>
                        <Container id='c-abrigo-desafios' size="lg" className="bg-base-100 rounded-2xl p-6 shadow-xl">
                            <h3 className="text-xl xl:text-3xl font-bold mb-4 text-center">Nossos Maiores Desafios</h3>
